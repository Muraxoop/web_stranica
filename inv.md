...
<body>
    ...
    $sql = "SELECT Proizvodac, Model, GodinaProizvodnje, Cijena, Slika FROM Inventar ORDER BY Proizvodac, Model";
...
if (!empty($row["Slika"])) {
    ...
    echo "<img src='data:image/png;base64, $imageData' alt='Slika auta'>";
} else {
